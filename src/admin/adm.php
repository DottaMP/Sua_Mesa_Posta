                                ...
                                <div class="card__body">
                                    <form>
                                        <div class="d-flex justify-content-center mt-4">
                                            <button type="button" class="btn btn-primary mr-3" name="b1">
                                            <a class="text-white" href="produtos.php" target="_top">Crud Produtos</a></button>
                                            <button type="button" class="btn btn-primary mr-3" name="b2">
                                            <a class="text-white" href="lista.php" target="_top">Listar Produtos</a></button>
                                            <button type="button" class="btn btn-primary mr-3" name="b3">
                                            <a class="text-white" href="lista_cliente.php" target="_top">Listar Clientes</a></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
